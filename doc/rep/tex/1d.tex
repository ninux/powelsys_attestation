	...
	\begin{subfigure}[b]{0.9\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addlegendentry{$H_3$};
				\draw[red, dashed] (axis cs: 1000,-120) node[above right]{Phase Margin $\varphi_{R}$} -- (axis cs: 100000,-120);
