...
The bode diagram of the open loop systems shows, that the crossover frequency
is below the frequency at the specified phase margin. Further, the diagram shows,
that there is significant gap between the crossover frequency and the frequency,
where the phase margin is met. Therefore, the controller could even be set to
higher dynamics with lower attenuation of the controller and still meeting the
