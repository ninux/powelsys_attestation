...
\begin{abstract}
	...
	The report shows how an ideal boost converter can be analysed for the
	frequency domain using the state space averaging method, hence, deriving
	the transfer function of the converter. Further, the report shows how a
	controller can be designed for the ideal boost converter using classic
	control theory with a direct feedback loop.

	The developed transfer functions of the power stage, the controller,
	and the closed loop behaviour are shown with simulation results using
	GNU Octave.
\end{abstract}
%%------------------------------------------------------------------------------
%% Hintergrund
